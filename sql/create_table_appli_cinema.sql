...
CREATE TABLE franchise (
                           ...
                           siege_social TEXT,
                           id_gerant INTEGER,
                           CONSTRAINT fk_gerant_franchise FOREIGN KEY(id_gerant) REFERENCES utilisateur(id_utilisateur) ON DELETE SET NULL
);

-- Création de la table cinema
-- Un cinéma appartient à une seule franchise
-- RESTRICT : impossible de supprimer une franchise si elle possède encore des cinémas
CREATE TABLE cinema (
                        ...
                        CONSTRAINT fk_franchise_cinema FOREIGN KEY(id_franchise) REFERENCES franchise(id_franchise) ON DELETE RESTRICT
);

-- Création de la table salle
-- La colonne id_cinema sert de clé étrangère pour lier la salle à un cinéma
-- RESTRICT : impossible de supprimer un cinéma s'il possède encore des salles
CREATE TABLE salle (
                       ...
                       CONSTRAINT fk_cinema FOREIGN KEY(id_cinema) REFERENCES cinema(id_cinema) ON DELETE RESTRICT
);
